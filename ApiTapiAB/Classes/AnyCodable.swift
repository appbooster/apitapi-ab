...
extension AnyCodable: CustomDebugStringConvertible {
  ...
  var debugDescription: String {
    switch value {
    case let value as CustomDebugStringConvertible: return "AnyCodable(\(value.debugDescription))"
    default: return "AnyCodable(\(description))"
    }
  }
...
extension AnyEncodable: Equatable {
  ...
  static func == (lhs: AnyEncodable, rhs: AnyEncodable) -> Bool {
    ...
    case let (lhs as Double, rhs as Double): return lhs == rhs
    case let (lhs as String, rhs as String): return lhs == rhs
    case let (lhs as [String: AnyEncodable], rhs as [String: AnyEncodable]): return lhs == rhs
...
extension AnyEncodable: CustomDebugStringConvertible {
  ...
  var debugDescription: String {
    switch value {
    case let value as CustomDebugStringConvertible: return "AnyEncodable(\(value.debugDescription))"
    default: return "AnyEncodable(\(description))"
    }
  }
...
extension AnyDecodable: Equatable {
  ...
  static func == (lhs: AnyDecodable, rhs: AnyDecodable) -> Bool {
    switch (lhs.value, rhs.value) {
    case is (NSNull, NSNull), is (Void, Void): return true
    case let (lhs as Bool, rhs as Bool): return lhs == rhs
    case let (lhs as Int, rhs as Int): return lhs == rhs
    case let (lhs as Int8, rhs as Int8): return lhs == rhs
    case let (lhs as Int16, rhs as Int16): return lhs == rhs
    ...
    case let (lhs as Double, rhs as Double): return lhs == rhs
    case let (lhs as String, rhs as String): return lhs == rhs
    case let (lhs as [String: AnyDecodable], rhs as [String: AnyDecodable]): return lhs == rhs
...
extension AnyDecodable: CustomDebugStringConvertible {
  ...
  var debugDescription: String {
    ...
    default: return "AnyDecodable(\(description))"
    }
  }
